...
//               <button 
//                 className="flex-1 py-2 text-blue-500 font-medium border-r border-gray-300 hover:bg-gray-50 active:bg-gray-100 transition-colors max-h-[40px]"
//                 onClick={onCancel}
//               >
//                 {cancelText}
//               </button>
//             </Dialog.Close>
//             <button 
//               className={`flex-1 py-2 font-semibold hover:bg-gray-50 active:bg-gray-100 transition-colors max-h-[40px] ${
